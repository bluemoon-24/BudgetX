        ...
        <div class="grid grid-cols-1 gap-5 sm:grid-cols-3 mb-8">
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <dd class="mt-1 text-3xl font-semibold text-gray-900"><?php echo $currency_symbol; ?>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <dd class="mt-1 text-3xl font-semibold text-green-600">+<?php echo $currency_symbol; ?>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <dd class="mt-1 text-3xl font-semibold text-red-600">-<?php echo $currency_symbol; ?>
                    ...
                    <?php else: ?>
                        <?php foreach (array_slice($recentIncome, 0, 5) as $income): ?>
                            <li class="px-4 py-4 flex items-center justify-between hover:bg-gray-50">
                                ...
                                <div class="text-sm text-green-600 font-semibold">+<?php echo $currency_symbol; ?>
                    ...
                    <?php else: ?>
                        <?php foreach (array_slice($recentExpenses, 0, 5) as $expense): ?>
                            <li class="px-4 py-4 flex items-center justify-between hover:bg-gray-50">
                                ...
                                <div class="text-sm text-red-600 font-semibold">-<?php echo $currency_symbol; ?>
