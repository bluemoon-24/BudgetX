            ...
            <div class="border-t border-gray-200">
                <form action="/BudgetX/public/income/store" method="POST" class="px-4 py-5 sm:p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" name="source" id="source" required class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="e.g. Salary, Freelance">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="date" name="date" id="date" required value="<?php echo date('Y-m-d'); ?>" class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                    </div>
