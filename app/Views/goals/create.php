            ...
            <div class="border-t border-gray-200">
                <form action="/BudgetX/public/goals/store" method="POST" class="px-4 py-5 sm:p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="text" name="name" id="name" required class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="e.g. Vacation Fund">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            ...
                            <input type="number" name="target_amount" id="target_amount" step="0.01" required class="focus:ring-blue-500 focus:border-blue-500 block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md" placeholder="0.00">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input type="date" name="deadline" id="deadline" class="shadow-sm focus:ring-blue-500 focus:border-blue-500 block w-full sm:text-sm border-gray-300 rounded-md">
                        </div>
                    </div>
