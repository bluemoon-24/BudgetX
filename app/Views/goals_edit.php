    ...
    <div class="px-4 py-6 sm:px-0">
        <div class="max-w-md mx-auto bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="px-4 py-5 sm:px-6 flex justify-between items-center">
                <div>
                    <h3 class="text-lg leading-6 font-medium text-gray-900">Edit Goal</h3>
                    <p class="mt-1 max-w-2xl text-sm text-gray-500">Update your savings target.</p>
                </div>
                <form action="/BudgetX/public/goals/delete" method="POST" onsubmit="return confirm('Are you sure you want to delete this goal?');">
            ...
            <div class="border-t border-gray-200">
                <form action="/BudgetX/public/goals/update" method="POST" class="px-4 py-5 sm:p-6 space-y-6">
                    <input type="hidden" name="id" value="<?php echo $goal['id']; ?>">
                    ...
                    <div class="pt-4 flex gap-3">
                        <a href="/BudgetX/public/goals" class="flex-1 inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                            Cancel
                        </a>
